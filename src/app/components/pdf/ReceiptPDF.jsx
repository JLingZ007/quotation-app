...
const ReceiptPDF = ({ form, services = [], brand, model, remark, warranty = [], docNumber, totalPrice = 0 }) => {
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.docTitleContainer}>
            <Text style={styles.docTitle}>ใบกำกับภาษี / ใบเสร็จรับเงิน</Text>
          </View>
        ...
        <View style={styles.customerSection}>
          <View style={styles.customerInfo}>
            ...
            <Text style={styles.infoText}>ที่อยู่: {form?.address || '-'}</Text>
            <Text style={styles.infoText}>เลขประจำตัวผู้เสียภาษี: {form?.tax_number || '-'}</Text>
          </View>
          ...
          <View style={styles.totalSection}>
            <View style={styles.totalTable}>
              ...
              <View style={styles.totalRow}>
                ...
                <View style={styles.totalValueCell}>
                  <Text>{numberWithCommas(Vat)}</Text>
                </View>
              </View>
              <View style={styles.totalRow}>
